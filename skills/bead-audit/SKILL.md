...
- To decide whether a bead deserves to exist, or to prune, merge, defer, or kill beads across a backlog by product value. Use `/bead-refine` for that; it owns the word "refine". This skill checks correctness, not value
