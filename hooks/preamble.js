...
const RESPONSE_FALLBACK = [
  ...
  'that changes what the reader does next. Write in Simplified Technical',
  'English (the ASD-STE100 writing rules, not its licensed dictionary): one',
  'word carries one meaning, one part of speech per word, active voice, no',
