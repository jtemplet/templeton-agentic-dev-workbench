...
//   1. SessionStart  stdout is the RAW preamble and contains the marker phrase.
//   2. SubagentStart stdout parses as JSON and
//      hookSpecificOutput.additionalContext contains the preamble + marker.
...
// --- 1. SessionStart: raw preamble containing the marker -------------------
check('SessionStart emits raw preamble with the marker', () => {
  ...
  assert.ok(out.includes(MARKER), 'stdout must contain the observability marker');
