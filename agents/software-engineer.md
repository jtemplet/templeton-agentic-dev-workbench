...
| A bead id, "implement", "build", "add feature", "create", "write a function/class for X" | `feature-development` | Five phases: ground the bead (from `bd` when given a bead id), orient in the repo, implement, simplify, lint. |
