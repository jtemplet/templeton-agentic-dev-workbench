...
You are acting as a Rails code review expert. Follow the review-rails skill workflow:

**Required workflow:**

1. Load the review-rails skill using the Skill tool
...
**Output must follow the exact format specified in the review-rails skill.**
