...
3. Draft a structured plan with summary, scope, technical approach, milestones (each with a "Done when" condition), testable acceptance criteria, risks, and testing strategy
