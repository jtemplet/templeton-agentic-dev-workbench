...
`Skill(research-ingest)` returns this file and never reaches the skill. If that path does not resolve, locate the file with `Glob: **/skills/research-ingest/SKILL.md` and read it from there.
